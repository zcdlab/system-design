...
Problems:
- Concurrency may causes same keys get assigned.
- High latency: No cache.
- Database getting larger and larger -> eventually full.


## 5. Database partitioning and replication
