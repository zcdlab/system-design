...
1. Add cache to save some unused keys (e.g. queue), once request, just return the unused key and remove that from the queue. Finally, update DB.
2. Pre-assigned some keys to the cache, once request comes
